...
public class Student extends User {
    ...
    private Coursecode studycourse;
    ...
    public Coursecode getStudyCourse(){
    ...
    public void setStudyCourse(Coursecode coursecode){
    
        this.studycourse=coursecode;
    
    }
    
    public void setStudyCourse(String coursename){
    
      this.studycourse = Coursecode.valueOf(coursename);
